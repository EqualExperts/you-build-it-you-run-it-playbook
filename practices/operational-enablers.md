...
If you don't implement specialists as a service, you'll suffer from the [embedded specialists pitfall](https://you-build-it-you-run-it.playbook.ee/pitfalls#embedded-specialists), and endure time-consuming interactions with some operational teams.
